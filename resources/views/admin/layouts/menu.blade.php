    ...
    <div class="kt-header__topbar">
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon">
                    @if (App::isLocale('en'))
                        <img class="" alt="Language English" style="width:30px;" src="{{ asset('adminPanal/assets/media/flags/020-flag.svg')}}"/>
                    @else
                        <img class="" alt="Language Arabic" style="width:30px;" src="{{ asset('adminPanal/assets/media/flags/008-saudi-arabia.svg')}}"/>
                    @endif
                </span>
            </div>
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    <li class="kt-nav__item kt-nav__item--active">
                        <a href="{{ aurl('lang/en') }}" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="{{ asset('adminPanal/assets/media/flags/020-flag.svg')}}" alt="" /></span>
                            <span class="kt-nav__link-text">{{ trans('admin.English') }}</span>
                        </a>
                    </li>
                    <li class="kt-nav__item">
                        <a href="{{ aurl('lang/ar') }}" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="{{ asset('adminPanal/assets/media/flags/008-saudi-arabia.svg')}}" alt="" /></span>
                            <span class="kt-nav__link-text">{{ trans('admin.Arabic') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <span class="kt-header__topbar-username kt-hidden-mobile">{{ admin()->user()->name }}</span>
                    <img class="kt-hidden" alt="Pic" src="{{ asset('adminPanal/assets/media/users/300_25.jpg')}}" />
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                ...
                <div class="kt-notification">
                    <div class="kt-notification__custom kt-space-between">
                        <a href="{{ url('admin/logout') }}" class="btn btn-label btn-label-brand btn-sm btn-bold">{{ trans('admin.logout') }}</a>
                        <a href="demo1/custom/user/login-v2.html" target="_blank" class="btn btn-clean btn-sm btn-bold">Edit Profile</a>
                    </div>
                </div>
