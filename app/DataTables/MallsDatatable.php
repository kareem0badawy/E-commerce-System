...
class MallsDatatable extends DataTable {
    ...
    public function dataTable($query) {
        return datatables()
            ->eloquent($query)
            ->addColumn('actions', 'admin.malls.buttons.actions')
            ->addColumn('checkbox', 'admin.malls.buttons.checkbox')
			->rawColumns([
				'actions',
				'checkbox',
			]);
    ...
    protected function getColumns() {
        return [
            [
                ...
                'name'  => 'country_id.name_' . session('lang'),
                'data'  => 'country_id.name_' . session('lang'),
