...
class StatesController extends Controller {
	...
	public function index(StateDatatable $state) {
		...
		// return $state->render('admin.cities.index', ['title' => trans('admin.cities')]);
	...
	public function create() {
		...
		return view('admin.states.manage', ['title' => trans('admin.create_states')]);
	}
	...
	public function edit($id) {
		...
		return view('admin.states.manage', compact('state', 'title'));
	}
